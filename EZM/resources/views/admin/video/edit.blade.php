    ...
    <form action="{{ route('video.update' ,$video->id ) }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <textarea name="description" maxlength="65535" value="{{ $video->discription }}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="category_id" type="text" class="form-control @error('category_id') is-invalid @enderror"
                        name="courses_id" value="{{ old('courses_id', $video->courses_id) }}" autofocus>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                        onclick="location.href='{{ route('index.video') }}'">Cancel</button>

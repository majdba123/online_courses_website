...
<form action= "{{ route('courses.update' ,$courses->id )}}" method="POST" >
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <label>Doctor</label>
        <div class="col-sm-10">
            <select id="category_id" type="text" class="form-control @error('category_id') is-invalid @enderror" name="doctor_id" value="{{ old('doctor_id', $courses->doctor_id) }}" autofocus>
        ...
        <div class="col-sm-10">
            <select id="category_id" type="text" class="form-control @error('category_id') is-invalid @enderror" name="discount_id"  value="{{ old('discount_id', $courses->discount_id) }}" autofocus>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" onclick="location.href='{{ route('index.courses') }}'">Cancel</button>
